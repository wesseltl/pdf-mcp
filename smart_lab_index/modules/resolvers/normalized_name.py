...
class NormalizedNameResolver(ResolverModule):
    order = 30
    manifest = ModuleManifest(
        module_id="resolver.normalized_name",
        name="Normalized Name Resolver",
        version="0.1.0",
        module_type=ModuleType.RESOLVER,
        description="Resolves unique names after Unicode and whitespace normalization.",
    ...
    def resolve(
        ...
        if not name:
            return None
        entity = repository.find_entity_by_normalized_name(
